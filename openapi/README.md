...
*PaperApi* | [**GetNewPaperAccount**](docs/PaperApi.md#getnewpaperaccount) | **Get** /paper/1/acc/{paper_account_id}/acc/reset/{amount} | getPaperOrders
...
## Documentation For Models
 ...
 - [ResetPaperAccountResponse](docs/ResetPaperAccountResponse.md)
