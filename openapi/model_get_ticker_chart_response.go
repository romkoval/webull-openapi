...
func (o *GetTickerChartResponse) GetDates() []GetTickerChartResponseDates {
	if o == nil || o.Dates == nil {
		var ret []GetTickerChartResponseDates
		return ret
	}
	return *o.Dates
}
...
// SetDates gets a reference to the given []GetTickerChartResponseDates and assigns it to the Dates field.
