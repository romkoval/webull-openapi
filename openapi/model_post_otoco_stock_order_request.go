...
func NewPostOtocoStockOrderRequest() *PostOtocoStockOrderRequest {
	this := PostOtocoStockOrderRequest{}
	return &this
}
...
func (o PostOtocoStockOrderRequest) MarshalJSON() ([]byte, error) {
...
type NullablePostOtocoStockOrderRequest struct {
	value *PostOtocoStockOrderRequest
	isSet bool
}

func (v NullablePostOtocoStockOrderRequest) Get() *PostOtocoStockOrderRequest {
	return v.value
}

func (v *NullablePostOtocoStockOrderRequest) Set(val *PostOtocoStockOrderRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostOtocoStockOrderRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostOtocoStockOrderRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostOtocoStockOrderRequest(val *PostOtocoStockOrderRequest) *NullablePostOtocoStockOrderRequest {
	return &NullablePostOtocoStockOrderRequest{value: val, isSet: true}
}

func (v NullablePostOtocoStockOrderRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostOtocoStockOrderRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
